...
- For clear specs, execution checklists, blockerboards, and measurable acceptance criteria, use Luna-xhigh as the cheap control plane. Route mechanical lookup, extraction, and inventory to Luna-low; ordinary implementation and tracing to Luna-high, or Terra-medium when depth is required; judgment-oriented QA to Sol-low; scope interpretation, reconciliation, and meaningful integration QA to Terra-high; and material architecture, security, release, or conflicting-evidence judgment to Sol-high. Use xhigh only for one bounded worker pass after lower effort proves insufficient.
